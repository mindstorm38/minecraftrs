...
pub trait PosDistrib {
    fn pick_pos(&self, world: &mut ChunkMap, rand: &mut JavaRandom, x: i32, y: i32, z: i32) -> Option<(i32, i32, i32)>;
}
...
impl PosDistrib for UniformVerticalDistrib {
    fn pick_pos(&self, _world: &mut ChunkMap, rand: &mut JavaRandom, x: i32, _y: i32, z: i32) -> Option<(i32, i32, i32)> {
